...
namespace bolnica.Repository.CSV.Converter
{
   ...
   public class DoctorCSVConverter : ICSVConverter<Doctor>

    {
        ...
        {           // id, String name, String surname, String jmbg, String email, String phone, DateTime birth, String adress, String username, String password, Image img, Speciality spec
           string[] tokens = entityCSVFormat.Split(_delimiter.ToCharArray());

            Doctor doct = new Doctor(long.Parse(tokens[0]), tokens[1], tokens[2], tokens[3], tokens[4], tokens[5], DateTime.Parse(tokens[6]), new Address(long.Parse(tokens[7])), tokens[8], tokens[9],null, new Speciality(long.Parse(tokens[10]))); //(Bitmap)Bitmap.FromFile("../../Images/"+tokens[8]+".Jpeg")
        ...
        public string ConvertEntityToCSVFormat(Doctor entity)
        {
           ...
           // entity.Image.Save("../../Images/" + entity.Username + "Jpeg", System.Drawing.Imaging.ImageFormat.Jpeg);
            string generalData = string.Join(_delimiter, entity.Id, entity.FirstName, entity.LastName, entity.Jmbg, entity.Email, entity.Phone, entity.DateOfBirth, entity.Address.GetId(), entity.Username, entity.Password,  entity.Specialty.GetId());
