    ...
    public class SecretaryCSVConverter : ICSVConverter<Secretary>
    {
        ...
        public Secretary ConvertCSVFormatToEntity(string entityCSVFormat)
        {
            ...
            return new Secretary(long.Parse(tokens[0]), 
                tokens[1], tokens[2], /*(Bitmap) Bitmap.FromFile("../../../../UserInterface/UserInterface/Resources/Images/" + tokens[1] + ".Jpeg")*/ (Bitmap)Bitmap.FromFile("C:/Users/Asus/Desktop/SIMS/hospital_system/UserInterface/UserInterface/Resources/Images/Pera.Jpeg"),
        ...
        public string ConvertEntityToCSVFormat(Secretary entity)
        {
            ...
            return String.Join(_delimiter, entity.GetId(), entity.Username, entity.Password, entity.FirstName, entity.Jmbg, entity.LastName, entity.Email, entity.Phone, entity.DateOfBirth, entity.Address.GetId(), entity.Address.Town.GetId(), entity.Address.Town.State.GetId());
        }
    }
}
