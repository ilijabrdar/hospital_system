...
namespace ComputationalGraph
{
    public class NeuronNode
    {
        ...
        public List<MultiplyNode> multiplyNodes { get; set; }
        public SumNode sumNode { get; set; }
        public SigmoidNode activation_node { get; set; }
        public List<double> previous_deltas { get; set; }
        public List<List<double>> gradients { get; set; }
